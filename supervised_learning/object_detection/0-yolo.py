#!/usr/bin/env python3
"""Write a class Yolo that uses the Yolo v3
algorithm to perform object detection"""
import tensorflow.keras as K


class Yolo:
    """Class Yolo to perform object detection using YOLOv3"""
    ...
    def __init__(self, model_path, classes_path, class_t, nms_t, anchors):
        ...
        the initial filtering step nms_t is a float representing the
