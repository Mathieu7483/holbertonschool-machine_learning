...
def conv_backward(dZ, A_prev, W, b, padding="same", stride=(1, 1)):
    """performs back propagation over a convolutional layer of neural network:
    ...
    sh is the stride for the height of the convolution
    sw is the stride for the width of the convolution
