...
class Node:
    ...
    def get_leaves_below(self):
        """Method that returns a list of all the leaves below the node"""
        leaves = []
        if self.left_child:
...
class Leaf(Node):
    ...
    def get_leaves_below(self):
        """Method that returns a list of all the leaves below the leaf"""
        return [self]
...
class Decision_Tree():
    ...
    def get_leaves(self):
        """Method that returns a list of all the leaves in the tree"""
