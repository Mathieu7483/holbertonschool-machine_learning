...
class BayesianOptimization:
    ...
    def acquisition(self):
        ...
        Returns:
            X_next (numpy.ndarray): Next best sample location, shape (1,).
            EI (numpy.ndarray): Expected improvement of each potential sample,
                                shape (s,).
        """
        # Predict the mean and standard deviation at the acquisition points
        mu, sigma = self.gp.predict(self.X_s)

        # Determine the current optimal value based on
        ...
        # Select the next sample point as the one
        # with the maximum expected improvement
